...
function Checkout() {
    ...
    const subtotal = cartItems.reduce((acc, item) => acc + item.sellingPrice * item.skuInventory[0].quantity, 0);
            ...
            <Row className="px-4">
                    ...
                    <div className="checkout-section">
                        ...
                        {cartItems.map((item, index) => (
                            <div key={index} className="checkout-item">
                                ...
                                <span>x {item.skuInventory[0].quantity}</span>
                                <span>${(item.sellingPrice * item.skuInventory[0].quantity).toFixed(2)}</span>
                            </div>
                        ))}
                    </div>
                ...
                <Col lg="4">
                    <div className="checkout-section">
                        ...
                        <Button color="success" className="mt-5" size="lg" block>Place Order</Button>
                    </div>
                </Col>
            </Row>
        </Container>
